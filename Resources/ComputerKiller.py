...
def SendPack(send_list, ip, port):
    print(send_list)
    ...
    def setupUi(self, MainWindow):
        ...
        def sendcomm():
            ...
            try:
                ...
                return 0
            try:
                list2 = [FormatMsgs(FormatPack(messget))]
                SendPack(send_list=list2, ip=ipget, port=portget)
                MessageBox(0, "发送成功", "提示", MB_ICONASTERISK)
            except Exception as e:
                MessageBox(0, "出现未知错误:%s" % e, "提示", MB_ICONWARNING)
                return 0
